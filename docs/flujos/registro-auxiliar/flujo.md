...
Auditando contra el schema de SUPERADMIN ([REGISTRO_SCHEMA.md](../../arquitecturas/REGISTRO_SCHEMA.md)):
...
Diagrama solo del lado **BE** — el wizard de UI vive en las capturas de [disenos/](disenos/).
