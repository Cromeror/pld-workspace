...
Wizard administrativo (operado por `SUPERADMIN`) para registrar **sujetos obligados** del sistema PLD: Notarías e Inmobiliarias, en perfil Persona Física o Persona Moral. Multi-step con resume vía `current_step`, dedupe por RFC, TTL 30 días configurable.

Endpoints bajo `/admin/registration/*`. Implementación inicial en change archivado [2026-04-22-add-registro-sujetos-obligados](../changes/archive/2026-04-22-add-registro-sujetos-obligados/) y extensiones posteriores.
